...
import { FaBuilding, FaHandshake, FaKey, FaBed, FaBath, FaRulerCombined } from "react-icons/fa";
...
const Hero = () => {
  ...
  const fetchLatestListings = async () => {
    try {
      ...
      // backend already sorts newest first in the current controller
      const response = await getPublicListings({ limit: 4, page: 1 });
    ...
    return (
      ...
      >
        ...
        <div className="p-2 sm:p-3">
          ...
          <div className="flex items-center gap-2 mt-2 text-[10px] sm:text-xs text-white/90 flex-wrap">
        ...
        <div className="flex flex-col-reverse lg:flex-row gap-8 lg:gap-12 xl:gap-16">
          ...
          <div className="w-full lg:w-1/2 space-y-4 sm:space-y-6 lg:space-y-8">
            <div className="inline-flex items-center space-x-2 bg-white/10 backdrop-blur-sm text-white px-3 py-1.5 sm:px-4 sm:py-2 rounded-full">
              ...
              <span className="text-xs sm:text-sm font-medium">Kenya&apos;s Property Platform</span>
            </div>
            ...
            <p className="text-sm sm:text-base md:text-lg text-[#A8D8C1] leading-relaxed">
              RendaHomes connects tenants directly with landlords. Browse verified homes,
              schedule viewings, and move into your next home faster. No middlemen, no
              hidden fees, just a smoother property experience.
            </p>
