            ...
            <div className="bg-white rounded-2xl shadow-lg border border-[#A8D8C1] p-8 space-y-8">
              ...
              <section id="introduction" className="scroll-mt-24">
                ...
                <div className="space-y-4 text-[#065A57] leading-relaxed">
                  <p>
                    Welcome to MakaoLink ("Company," "we," "our," "us"). These Terms of Service ("Terms") 
                    govern your use of our website, mobile applications, and services (collectively, the "Platform").
                  </p>
                  <p>
                    By accessing or using MakaoLink, you agree to be bound by these Terms. If you do not agree 
                    to any part of these Terms, you may not access or use our Platform.
                  </p>
                  <p>
                    MakaoLink is a property management platform that connects landlords with tenants in Kenya. 
              ...
              <section id="eligibility" className="scroll-mt-24">
                ...
                <div className="space-y-4 text-[#065A57] leading-relaxed">
                  <p>By using MakaoLink, you represent and warrant that:</p>
                  <ul className="list-disc pl-6 space-y-2">
              ...
              <section id="payments" className="scroll-mt-24">
                ...
                <div className="space-y-4 text-[#065A57] leading-relaxed">
                  ...
                  <ul className="list-disc pl-6 space-y-2">
                    ...
                    <li><span className="font-semibold">MakaoPro:</span> KES 2,500/month for 100+ properties with dedicated support.</li>
                  </ul>
              ...
              <section id="liability" className="scroll-mt-24">
                ...
                <div className="space-y-4 text-[#065A57] leading-relaxed">
                  <p>
                    To the maximum extent permitted by law, MakaoLink shall not be liable for any 
              ...
              <div className="mt-8 p-4 bg-[#F0F7F4] rounded-xl border border-[#A8D8C1] flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="font-semibold text-[#013E43]">By using MakaoLink, you agree to these Terms</p>
