  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.user?.role !== "admin") {
        setError("This portal is only for RendaHomes administrators.");
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-[#013E43] to-[#005C57]">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center w-full p-12 text-white">
          ...
          <p className="text-center text-[#A8D8C1] mb-8 max-w-md">
            Sign in to manage RendaHomes operations, app content, support, and publishing.
          </p>
        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <a
                href={`${import.meta.env.VITE_MAIN_URL || (import.meta.env.DEV ? "http://localhost:5173" : "https://rendahomes.com")}/forgot-password`}
          ...
          <p className="text-center text-sm text-[#065A57] mt-6">
            Admin access is managed by RendaHomes.
          </p>
