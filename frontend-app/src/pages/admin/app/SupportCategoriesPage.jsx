  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-white rounded-md shadow-sm p-4 border-l-4 border-gray-400">
          ...
          <form onSubmit={submit} className="p-6 space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <textarea
                  ...
                  className="w-full pl-10 pr-4 py-3 border-2 border-[#E4EEE8] rounded-lg focus:border-[#02BB31] outline-none transition-colors resize-none"
                  rows="4"
            ...
            <div className="flex gap-3">
              <button
                type="submit"
                disabled={loading}
                className="flex-1 py-3 bg-[#02BB31] text-white rounded-lg font-semibold hover:shadow-sm transition-all disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {loading ? (
                  <>
              ...
              {editingId && (
                <button
                  type="button"
                  onClick={cancelEdit}
                  className="px-4 py-3 border-2 border-[#E4EEE8] text-[#065A57] rounded-lg font-medium hover:bg-[#F0F7F4] transition-colors"
                >
                  Cancel
                </button>
              )}
