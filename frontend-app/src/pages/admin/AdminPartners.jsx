...
function AdminPartners() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Stats Card */}
      <div className="bg-white rounded-md shadow-sm p-6 border border-[#E4EEE8]">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <div className="p-3 bg-[#02BB31]/10 rounded-md">
      ...
      {partners.length > 0 && (
        <div className="bg-white rounded-lg shadow-sm p-4 border border-[#E4EEE8]">
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 border border-[#E4EEE8] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#02BB31] focus:border-transparent"
              />
            </div>
            ...
            <div className="flex items-center space-x-2">
              ...
              <select
                ...
                className="px-3 py-2 border border-[#E4EEE8] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#02BB31] text-[#065A57]"
              >
      ...
      {filteredPartners.length === 0 ? (
        ...
        <div className="space-y-6">
          {filteredPartners.map((partner) => (
            ...
            >
              {/* Partner Header */}
              <div className="p-6 border-b border-[#E4EEE8] bg-[#F8FAF8]">
                <div className="flex items-start justify-between">
                  <div className="flex items-center space-x-4">
                    {/* Company Logo */}
                    <div className="w-20 h-20 rounded-md overflow-hidden border-2 border-[#E4EEE8] bg-white">
                      {partner.logo?.url ? (
                        <img
                        ...
                        <div className="w-full h-full bg-[#013E43] flex items-center justify-center">
              ...
              <div className="p-6">
                      ...
                      {partner.documents.map((doc, index) => (
                        ...
                        >
                          <img
                            ...
                            className="h-24 w-full object-cover rounded-lg border border-[#E4EEE8] group-hover:border-[#02BB31] transition-colors"
                          />
                ...
                {/* Action Buttons */}
                <div className="flex justify-end space-x-3 pt-4 border-t border-[#E4EEE8]">
                  <button
                    onClick={() => {
                  ...
                  <button
                    ...
                    className="px-6 py-2 bg-[#02BB31] text-white rounded-lg font-medium hover:shadow-sm transition-all flex items-center"
                  >
          ...
          <div className="bg-white rounded-lg shadow-sm max-w-md w-full p-6">
            ...
            <div className="mb-6">
              ...
              <textarea
                ...
                rows="3"
                className="w-full px-4 py-2 border border-[#E4EEE8] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#02BB31]"
