...
function AdminSettings() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Settings Form */}
      <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-sm border border-[#E4EEE8] overflow-hidden">
        {/* Tabs */}
        <div className="border-b border-[#E4EEE8] bg-[#F0F7F4]">
        ...
        <div className="p-8">
          ...
          {activeTab === "general" && (
            <div className="space-y-6">
              ...
              {/* Platform Status */}
              <div className="bg-[#F0F7F4] p-4 rounded-md border border-[#E4EEE8]">
        ...
        {/* Form Actions */}
        <div className="border-t border-[#E4EEE8] p-6 bg-[#F0F7F4]">
          <div className="flex justify-end">
            <button
              type="submit"
              disabled={saving}
              className="px-8 py-3 bg-[#02BB31] text-white rounded-lg font-semibold hover:shadow-sm transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center space-x-2"
            >
              {saving ? (
                <>
