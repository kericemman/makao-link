                ...
                {application.logo ? (
                  ...
                  >
                    <img
                      ...
                      className="h-20 w-20 rounded-md object-cover border-2 border-[#E4EEE8] group-hover:border-[#02BB31] transition-all"
                    />
                ...
                {application.documents.map((doc, index) => (
                  ...
                  >
                    <img
                      ...
                      className="h-24 w-full object-cover rounded-lg border border-[#E4EEE8] group-hover:border-[#02BB31] transition-all"
                    />
