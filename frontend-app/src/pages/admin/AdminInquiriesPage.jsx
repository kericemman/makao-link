...
const statusIcons = {
  new: <FiStar className="text-white" />,
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-sm p-6 border border-[#E4EEE8]">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-xl font-bold text-[#013E43]">Inquiry Oversight</h1>
      ...
      {filteredInquiries.length === 0 ? (
        ...
        <div className="grid gap-6">
          {filteredInquiries.map((inquiry) => (
            <div
              key={inquiry._id}
              className="bg-white rounded-lg shadow-sm border border-[#E4EEE8] overflow-hidden transition-all cursor-pointer"
              onClick={() => {
                ...
                <div className="flex flex-col lg:flex-row gap-6">
                  ...
                  <div className="flex-1">
                    <div className="flex flex-wrap items-center gap-3 mb-4">
                      <div className="flex items-center space-x-3">
                        <div className="w-12 h-12 bg-[#013E43] rounded-full flex items-center justify-center text-white font-bold text-lg">
                      ...
                      <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium capitalize ${statusClasses[inquiry.status]}`}>
                        ...
                        <span className="ml-1 text-white">{inquiry.status}</span>
                      </span>
                    </div>
                  ...
                  <div className="lg:w-64">
                    <div className="bg-[#F0F7F4] rounded-md p-4">
      ...
      {showDetailsModal && selectedInquiry && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg shadow-sm max-w-3xl w-full max-h-[90vh] overflow-y-auto">
            {/* Modal Header */}
            <div className="sticky top-0 bg-white border-b border-[#E4EEE8] p-6 flex items-center justify-between">
              <div className="flex items-center space-x-3">
                <div className="w-14 h-14 bg-[#013E43] rounded-full flex items-center justify-center text-white font-bold text-xl">
            ...
            <div className="p-6 space-y-6">
              ...
              {/* Contact Actions */}
              <div className="flex flex-wrap gap-3 pt-4 border-t border-[#E4EEE8]">
                {selectedInquiry.phone && (
                  <>
                    <a
